...
Public Class Orders
    ...
    Private Sub InitializeTable()
        ...
        tblMenu.Columns.Add("USERNAME", "CUSTOMER")
    ...
    Private Sub btnComplete_Click(sender As Object, e As EventArgs) Handles btnComplete.Click
        ...
        For Each row As DataGridViewRow In tblMenu.SelectedRows
            ...
            For Each order As ProductOrder In Login.CartList
                If order.Username = username AndAlso order.Name = name AndAlso order.Status <> "Completed" Then
    ...
    Private Sub btnCancel_Click(sender As Object, e As EventArgs) Handles btnCancel.Click
        ...
        For Each row As DataGridViewRow In tblMenu.SelectedRows
            ...
            For Each order As ProductOrder In Login.CartList
                If order.Username = username AndAlso order.Name = name AndAlso order.Status <> "Pending" Then
    ...
    Private Sub txtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged
        LoadCartData(txtSearch.Text.Trim().ToLower())
    End Sub
